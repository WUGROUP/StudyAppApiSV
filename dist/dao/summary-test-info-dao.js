...
var SummaryTestInfoDao = /** @class */ (function () {
    ...
    SummaryTestInfoDao.insert = function (title, flg) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var db = dbutils_1.DbUtils.DbInstance;
            db.serialize(function () {
                db.run(_this.INSERT_SQL, [title, flg], function (error) {
                    if (error) {
                        db.close();
    ...
    SummaryTestInfoDao.getTestedList = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var db = dbutils_1.DbUtils.DbInstance;
            db.serialize(function () {
                db.all(_this.SELECT_ALL_TESTED_LIST, function (error, rows) {
                    if (error) {
                        console.error('Error!', error);
                        reject(error);
                        return;
    ...
    SummaryTestInfoDao.updateTestResById = function (testRes) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var db = dbutils_1.DbUtils.DbInstance;
            db.serialize(function () {
                db.run(_this.UPDATE_TEST_RES, [testRes.score, testRes.costTime, testRes.res[0].summaryId], function (error) {
                    if (error) {
                        console.error('Error!', error);
                        reject(error);
                        return;
